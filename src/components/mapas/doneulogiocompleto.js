      ...
      <div>
        ...
        >
          {({ zoomIn, zoomOut, setTransform, resetTransform, ...rest }) => (
            <React.Fragment>
<div style={{ position: 'fixed', bottom: 20, left: 10, zIndex: 2, display: 'flex', flexDirection: 'column' }}>                <IconButton
 ...
 <g stroke-width="1" fill-rule="evenodd" stroke-linecap="square" fill="none" stroke-linejoin="bevel" stroke="black">
  ...
  <g stroke-width="10.2362" fill-opacity="0.127001" transform="matrix(0.999998,0,0,0.999998,0,0)" font-family="MS Shell Dlg 2" stroke-opacity="0.127001" stroke-linecap="square" font-style="normal" font-size="108.333" fill="#e4e7d6" stroke-linejoin="bevel" font-weight="400" stroke="#232323">
        ...
        {[100].map((tooltipValue) => {
          ...
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(100)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M1868.78,4356.08 L1958.48,4354.6 L1957.5,4483.24 L1869.77,4479.3 L1868.78,4356.08"/></Tooltip>)})}

        {[101].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(101)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M1961.44,4355.1 L2149.72,4356.58 L2148.73,4421.14 L1960.46,4418.68 L1961.44,4355.1"/></Tooltip>)})}

        {[102].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(102)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M1960.95,4421.14 L2147.74,4423.11 L2149.72,4487.18 L1957.5,4480.28 L1960.95,4421.14"/></Tooltip>)})}

        {[103].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(103)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2241.39,3974.6 L2434.1,3973.13 L2434.1,4037.69 L2240.9,4037.2 L2241.39,3974.6"/></Tooltip>)})}

        {[104].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(104)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2242.87,4038.68 L2434.1,4038.68 L2429.66,4103.24 L2240.9,4099.3 L2242.87,4038.68"/></Tooltip>)})}

        {[105].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(105)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2241.39,4103.73 L2430.16,4105.71 L2432.13,4166.33 L2238.93,4168.3 L2241.39,4103.73"/></Tooltip>)})}

        {[106].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(106)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2237.94,4168.3 L2431.14,4167.81 L2431.64,4230.4 L2240.9,4228.43 L2237.94,4168.3"/></Tooltip>)})}

        {[107].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(107)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2241.39,4232.37 L2429.66,4234.34 L2431.64,4296.45 L2240.4,4293.49 L2241.39,4232.37"/></Tooltip>)})}

        {[108].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(108)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2240.4,4295.95 L2431.14,4298.42 L2428.68,4360.52 L2239.91,4356.08 L2240.4,4295.95"/></Tooltip>)})}

        {[109].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(109)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2239.42,4358.55 L2427.2,4362.49 L2428.68,4423.6 L2237.94,4423.11 L2239.42,4358.55"/></Tooltip>)})}

        {[110].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(110)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2237.45,4427.55 L2427.2,4426.56 L2426.71,4486.2 L2237.45,4483.73 L2237.45,4427.55"/></Tooltip>)})}

        {[111].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(111)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2508.03,3976.58 L2571.61,3975.59 L2567.67,4166.82 L2505.57,4167.31 L2508.03,3976.58"/></Tooltip>)})}

        {[112].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(112)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2574.07,3977.07 L2635.19,3978.05 L2634.2,4168.79 L2570.13,4167.31 L2574.07,3977.07"/></Tooltip>)})}

        {[113].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(113)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2636.67,3980.03 L2698.77,3979.53 L2696.8,4169.29 L2636.67,4168.3 L2636.67,3980.03"/></Tooltip>)})}

        {[114].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(114)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2506.06,4170.76 L2698.77,4170.76 L2698.77,4233.36 L2505.07,4232.87 L2506.06,4170.76"/></Tooltip>)})}

        {[115].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(115)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2505.07,4236.32 L2697.29,4237.3 L2693.84,4299.9 L2505.57,4294.47 L2505.07,4236.32"/></Tooltip>)})}

        {[116].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(116)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2502.61,4298.91 L2566.19,4299.4 L2565.7,4488.17 L2503.1,4487.18 L2502.61,4298.91"/></Tooltip>)})}

        {[117].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(117)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2567.67,4298.91 L2629.77,4299.4 L2627.8,4488.66 L2566.68,4488.17 L2567.67,4298.91"/></Tooltip>)})}

        {[118].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(118)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2632.23,4301.37 L2696.8,4303.35 L2691.87,4491.13 L2629.77,4490.14 L2632.23,4301.37"/></Tooltip>)})}

        {[119].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(119)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M1775.63,4566.04 L1866.32,4568.01 L1863.85,4744.46 L1774.15,4743.48 L1775.63,4566.04"/></Tooltip>)})}

        {[120].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(120)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M1868.29,4569 L1954.54,4568.01 L1953.56,4744.95 L1868.78,4745.45 L1868.29,4569"/></Tooltip>)})}

        {[121].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(121)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M1956.51,4569.49 L2148.24,4570.97 L2147.25,4659.69 L1955.03,4655.25 L1956.51,4569.49"/></Tooltip>)})}

        {[122].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(122)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M1957.01,4660.18 L2146.27,4660.18 L2148.24,4749.88 L1957.01,4746.43 L1957.01,4660.18"/></Tooltip>)})}

        {[123].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(123)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M1774.15,4747.91 L1955.53,4747.91 L1953.06,4835.15 L1774.15,4834.66 L1774.15,4747.91"/></Tooltip>)})}

        {[124].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(124)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M1957.01,4748.9 L2145.28,4751.36 L2145.28,4839.58 L1955.03,4834.66 L1957.01,4748.9"/></Tooltip>)})}

        {[125].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(125)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M1773.66,4838.6 L1951.58,4837.12 L1953.56,4925.84 L1772.67,4925.34 L1773.66,4838.6"/></Tooltip>)})}

        {[126].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(126)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M1954.05,4839.09 L2144.79,4841.06 L2144.79,4931.75 L1955.53,4925.34 L1954.05,4839.09"/></Tooltip>)})}

        {[127].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(127)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M1772.18,4927.31 L1952.08,4928.3 L1950.6,5023.92 L1772.18,5021.94 L1772.18,4927.31"/></Tooltip>)})}

        {[128].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(128)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M1954.54,4929.29 L2143.8,4933.23 L2144.29,5027.37 L1951.58,5024.9 L1954.54,4929.29"/></Tooltip>)})}

        {[129].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(129)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M1770.21,5025.39 L1951.58,5025.89 L1949.12,5122 L1766.27,5120.02 L1770.21,5025.39"/></Tooltip>)})}

        {[130].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(130)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M1953.56,5028.35 L2141.34,5029.34 L2140.35,5126.92 L1949.61,5123.47 L1953.56,5028.35"/></Tooltip>)})}

        {[131].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(131)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2234,4570.48 L2426.71,4576.39 L2426.71,4663.63 L2234.98,4660.67 L2234,4570.48"/></Tooltip>)})}

        {[132].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(132)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2428.68,4576.89 L2511.48,4576.39 L2508.28,4754.56 L2426.95,4753.58 L2428.68,4576.89"/></Tooltip>)})}

        {[133].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(133)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2512.47,4577.87 L2599.21,4577.87 L2594.28,4754.81 L2509.51,4753.83 L2512.47,4577.87"/></Tooltip>)})}

        {[134].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(134)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2600.2,4578.86 L2691.87,4577.87 L2690.39,4754.32 L2594.77,4754.56 L2600.2,4578.86"/></Tooltip>)})}

        {[135].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(135)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2235.48,4663.14 L2423.75,4665.6 L2425.47,4753.58 L2234.49,4749.39 L2235.48,4663.14"/></Tooltip>)})}

        {[136].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(136)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2233.5,4752.84 L2466.88,4754.32 L2466.63,4841.56 L2232.52,4841.06 L2233.5,4752.84"/></Tooltip>)})}

        {[137].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(137)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2469.34,4756.54 L2691.87,4757.28 L2688.42,4845.01 L2468.6,4842.05 L2469.34,4756.54"/></Tooltip>)})}

        {[138].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(138)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2231.53,4843.03 L2467.12,4844.51 L2464.66,4932.24 L2231.04,4932.24 L2231.53,4843.03"/></Tooltip>)})}

        {[139].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(139)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2469.09,4845.01 L2687.56,4846.36 L2685.95,4936.19 L2465.64,4931.75 L2469.09,4845.01"/></Tooltip>)})}

        {[140].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(140)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2230.55,4935.69 L2462.69,4933.72 L2462.69,5029.34 L2234,5030.32 L2230.55,4935.69"/></Tooltip>)})}

        {[141].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(141)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2463.67,4934.71 L2686.94,4937.17 L2686.45,5033.28 L2465.15,5031.8 L2463.67,4934.71"/></Tooltip>)})}

        {[142].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(142)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2233.5,5032.79 L2461.7,5035.74 L2462.69,5127.91 L2229.56,5125.45 L2233.5,5032.79"/></Tooltip>)})}

        {[143].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(143)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2464.66,5036.73 L2685.95,5036.73 L2686.45,5130.87 L2464.16,5127.42 L2464.66,5036.73"/></Tooltip>)})}

        {[144].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(144)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M1749.66,5149.41 L1745.97,5232.58 L2967.2,5571.27 L2964.42,5148.95 L2731.54,5143.87 L2731.54,5163.27 L2230.67,5163.27 L2226.97,5203.94 L2142.88,5188.69 L2141.95,5154.96 L1749.66,5149.41"/></Tooltip>)})}

        {[145].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(145)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2636.82,1858.61 L2720.92,1860.92 L2721.84,2122.44 L2741.71,2122.91 L2742.17,1859.07 L2822.11,1858.61 L2823.03,1839.2 L2742.17,1838.28 L2742.63,1777.75 L2756.96,1774.51 L2769.9,1763.88 L2774.52,1755.57 L2782.83,1740.78 L2783.3,1712.13 L2774.52,1699.19 L2767.59,1689.49 L2761.58,1683.02 L2748.18,1677.02 L2741.25,1674.24 L2717.22,1672.86 L2705.67,1678.86 L2702.43,1682.56 L2695.04,1691.34 L2689.5,1696.42 L2679.33,1706.13 L2678.41,1712.13 L2677.48,1744.01 L2686.72,1758.34 L2691.35,1765.27 L2695.97,1770.35 L2711.21,1779.13 L2724.61,1779.59 L2724.15,1838.28 L2635.9,1840.59 L2637.75,1649.29 L2916.83,1677.02 L2760.65,2249.51 L2633.59,2244.43 L2636.82,1858.61"/></Tooltip>)})}

      
            <Tooltip title="Proyeccion">
            <path fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2982.44,5135.09 L2973.2,5587.91 L6458.08,6541.6 L6460.85,3157.46 L6154.04,3113.1 L5054.33,3029.01 L5044.17,3089.08 L4931.42,3383.87 L2776.83,3030.4 L2776.6,3400.51 L2749.33,5131.39 L2982.44,5135.09"/>
</Tooltip>
        {[147].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(147)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M5291.37,1424.73 L5853.01,1761.8 L6202.79,2350.93 L6437.51,3031.09 L6367.28,3040.33 L5958.82,2968.25 L5072.58,2898.94 L5291.37,1424.73"/></Tooltip>)})}

        {[148].map((tooltipValue) => {
          const objetoEncontrado = lotes.find(item => item.mapa1 == tooltipValue);
          return (
            <Tooltip title={objetoEncontrado ? "Manzana "+objetoEncontrado.manzana+" Lote "+objetoEncontrado.lote : 'Sin datos'}>
            <path onClick={() => handleOpenDialog(148)} fillOpacity={imagenDeFondoActivada ?  0.000001:1 }  fill-rule="evenodd" vector-effect="none" d="M2582.07,2999.67 L2773.36,3032.01 L2773.36,3335.13 L2574.67,3331.43 L2582.07,2999.67"/></Tooltip>)})}
  </g>
